...
app.Search = Backbone.Model.extend({  
  url: function() {
    return 'http://alwaysladylove.com:80/1/post/tag/' + this.tag
  },
  tag: '',
  defaults: {
    success: false,
...
app.Post = Backbone.Model.extend({  
  url: function() {
    return 'http://alwaysladylove.com:80/1/post' + this.query
  },
  query: '',
  defaults: {
    success: false,
...
app.SinglePost = Backbone.Model.extend({  
  url: 'http://alwaysladylove.com:80/1/post',
  defaults: {
    success: false,
    errors: [],
    errfor: {},
...
app.PurchasePost = Backbone.Model.extend({  
  url: function() {
    return 'http://alwaysladylove.com:80/1/post/' + this.attributes.id + '/pay'
  },
  defaults: {
    success: false,
    errors: [],
